  ...
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        ...
        <span style="margin-top: 96px; margin-left: 20px">选择月份：</span>
  ...
  methods: {
    ...
    getTotalIncome() {
      ...
      axios({
        method: "get",
        url:
          "/api/transaction/getTotalIncome?userId=" +
          localStorage.getItem("userId") +
          "&startTime=" +
          startDate +
          "&endTime=" +
        ...
        this.totalIncome = resp.data.content;
        if (resp.data.code === "200") {
          // console.log("getTotalIncome执行成功");
          // console.log("getTotalIncome:" + resp.data.content);
        } else {
    ...
    getTotalExpense() {
      ...
      axios({
        method: "get",
        url:
          "/api/transaction/getTotalExpense?userId=" +
          localStorage.getItem("userId") +
          "&startTime=" +
          startDate +
          "&endTime=" +
